...
def shop():
    ...
    while True:
        ...
        if choice == 1:
            ...
            quantity = int(better_input())
            if player.money - quantity*100 >= 0:
                player.money -= quantity*100
                player.inventory['покебол'] += quantity
            else:
                better_print('У вас недостаточно средств!')
        if choice == 2:
            better_print('сколько товаров вы хотите купить?')
            quantity = int(better_input())
            if player.money - quantity*50 >= 0:
                player.money -= quantity*50
        ...
        if choice == 4:
            better_print('сколько товаров вы хотите купить?')
            quantity = int(better_input())
            if player.money - quantity*200 >= 0:
                player.money -= quantity*200
        ...
        if choice == 5:
            better_print('сколько товаров вы хотите купить?')
            quantity = int(better_input())
            if player.money - quantity*300 >= 0:
                player.money -= quantity*300
...
def start():
    ...
    first_pokemon = int(better_input())
    if first_pokemon == 1:
